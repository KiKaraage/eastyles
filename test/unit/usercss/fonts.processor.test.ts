...
import { extractFontFaces, injectFonts, resolveFontVariables } from '../../../services/usercss/fonts';
...
describe('Font Processing', () => {
  ...
  describe('injectFonts', () => {
    ...
    it('should set proper attributes on style element', () => {
      ...
      const styleElement = mockDocument.createElement.mock.results[0].value;
      expect(styleElement.setAttribute).toHaveBeenCalledWith('data-eastyles-fonts', 'true');
    });
  });
