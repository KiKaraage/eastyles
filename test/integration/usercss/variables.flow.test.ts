...
describe('Variable Change Flow Integration', () => {
  ...
  describe('Complete Variable Change Flow', () => {
    it('should handle color variable change and persist to storage', async () => {
      ...
      vi.mocked(storageClient.getUserCSSStyle).mockResolvedValue(mockUpdatedStyle);
      vi.mocked(storageClient.updateUserCSSStyleVariables).mockResolvedValue(mockUpdatedStyle);
    ...
    it('should handle multiple variable changes in single update', async () => {
      ...
      await variablePersistenceService.updateVariables(mockStyleId, variableUpdates);
    ...
    it('should handle variable reset to defaults', async () => {
      ...
      vi.mocked(storageClient.updateUserCSSStyleVariables).mockResolvedValue(mockResetStyle);
